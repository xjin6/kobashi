...
**[Download Codex Copilot Bridge.exe](https://github.com/xjin6/codex-copilot-bridge/releases/latest/download/Codex.Copilot.Bridge.exe)** (Windows, ~36 MB standalone)

No installation required. No dependencies. Just download and double-click.

## How It Works

1. **Double-click** the exe - a small UI window opens in your browser
...
- **Edge or Chrome** for the standalone app window (falls back to default browser)
...
- Auto-detects Edge/Chrome, falls back to default browser
